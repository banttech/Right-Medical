...
@section('content')
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">Add Sales Agent</h4>
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form id="formAccountSettings" method="POST"
                                action="{{ route('super_admin.create_sales_agent') }}">
                                @csrf
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label for="name" class="form-label">Sales Agent Name *</label>
                                        <input class="form-control" type="text" id="name" name="name"
                                            placeholder="Sales Agent Name" value="{{ old('name') }}" />
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="mt-2">
                                        <button type="submit" class="btn btn-primary me-2">Add Sales Agent</button>
                                    </div>
                                </div>
                            </form>
                        </div>
