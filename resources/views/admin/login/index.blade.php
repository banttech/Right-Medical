...
<head>
    ...
    <title>Right Medical - Admin Login</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Right Medical</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to Right Medical! 👋</h4>
                        <p class="mb-4">Please sign-in to your account and start the adventure</p>

                        @include('layouts.partials.messages')
                        <form class="mb-3" method="POST" action="{{ route('super_admin.signin') }}">
                            @csrf
                            <div class="mb-3">
