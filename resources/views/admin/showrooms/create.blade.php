...
@section('content')
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">Add Surgical Showroom</h4>
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            @include('layouts.partials.messages')
                            <form id="formAccountSettings" method="POST" action="{{ route('super_admin.create_showroom') }}">
                                @csrf
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input class="form-control" type="text" id="showroom_name" name="showroom_name"
                                            placeholder="Showroom Name" value="{{ old('showroom_name') }}" />
                                    ...
                                    <div class="mt-2">
                                        <button type="submit" class="btn btn-primary me-2">Add Surgical Showroom</button>
                                    </div>
                                </div>
                            </form>
                        </div>
